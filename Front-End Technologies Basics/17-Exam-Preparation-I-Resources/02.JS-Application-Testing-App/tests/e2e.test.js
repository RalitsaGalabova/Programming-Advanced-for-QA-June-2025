...
describe("e2e tests", () => {
    ...
    describe("CRUD", () => {
        ...
        test('Create an Album', async () => {
            ...
            albumName = `My album_${random}`

            await page.fill('#name', albumName)
            await page.fill('#imgUrl', '/imagese/Lorde.jpg')
            await page.fill('#price', '15')
            await page.fill('#releaseDate', '1.1.2026')
            await page.fill('#artist', 'Ivo')
            await page.fill('#genre', 'Rock')
            await page.fill('[name="description"]', 'My album')
