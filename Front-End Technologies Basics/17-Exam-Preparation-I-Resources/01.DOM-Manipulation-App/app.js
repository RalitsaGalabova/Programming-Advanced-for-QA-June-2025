...
function solve() {
    ...
    const purchaseTicketsNumElement = document.getElementById('purchase-num-tickets')
    ...
    function onAdd(e) {
        ...
        purchaseTicketsNumElement.textContent = ticketsNumElement.value
    ...
    function onEdit() {
        ...
        ticketsNumElement.value = purchaseTicketsNumElement.textContent
